...
jsPsych.plugins['image-slider-response'] = (function() {
  ...
  plugin.trial = function(display_element, trial) {
    ...
    if (trial.prompt !== null){
      ...
      html += '<span style="text-align: center; font-size: 20px;">'+'Drag the slider to indicate the attractiveness <br/> and press the spacebar to submit.'+'</span>';
    }
...
*/
    ...
    function end_trial(){
      ...
      var trialdata = {
        "rt": response.rt,
        "response": Number(response.response), //[sivaHack]
        "stimulus": trial.stimulus //[sivaHack]
      };
